 ...
 * @return {!Object}
 */
proto.todoList.GetTodoRequest.prototype.toObject = function(opt_includeInstance) {
 ...
 * @return {!proto.todoList.GetTodoRequest}
 */
proto.todoList.GetTodoRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.todoList.GetTodoRequest.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getId();
  if (f.length > 0) {
    writer.writeString(
